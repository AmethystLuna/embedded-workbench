...
| Package under test | `dsh-embedded-workbench` 0.8.6 (bundle patch `cordis.patch.yml`, entry id `embedded-workbench`) |
...
its `Session` snapshot read resolved on the new release.
